...
class Ui_WidgetTiff(object):
    def setupUi(self, WidgetTiff):
        ...
        self.groupBoxSignals.setMinimumSize(QtCore.QSize(0, 100))
        self.groupBoxSignals.setMaximumSize(QtCore.QSize(280, 100))
        ...
        self.signal1Label = QtWidgets.QLabel(self.groupBoxSignals)
        self.signal1Label.setObjectName("signal1Label")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.signal1Label)
        self.signal1ComboBox = QtWidgets.QComboBox(self.groupBoxSignals)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.signal1ComboBox.sizePolicy().hasHeightForWidth())
        self.signal1ComboBox.setSizePolicy(sizePolicy)
        self.signal1ComboBox.setObjectName("signal1ComboBox")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.signal1ComboBox)
        self.horizontalLayout_5.addLayout(self.formLayout)
        self.radioButtonSignal1 = QtWidgets.QRadioButton(self.groupBoxSignals)
        self.radioButtonSignal1.setText("")
        self.radioButtonSignal1.setObjectName("radioButtonSignal1")
        self.horizontalLayout_5.addWidget(self.radioButtonSignal1)
        ...
        self.horizontalLayout_3.addWidget(self.pushButtonSignalAdd)
        ...
        self.horizontalLayout_3.addWidget(self.pushButtonSignalRemove)
    ...
    def retranslateUi(self, WidgetTiff):
        ...
        self.signal1Label.setText(_translate("WidgetTiff", "#1"))
