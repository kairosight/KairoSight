...
class Ui_WidgetTiff(object):
    def setupUi(self, WidgetTiff):
        ...
        self.groupBoxTransform = QtWidgets.QGroupBox(WidgetTiff)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.groupBoxTransform.sizePolicy().hasHeightForWidth())
        self.groupBoxTransform.setSizePolicy(sizePolicy)
        self.groupBoxTransform.setMaximumSize(QtCore.QSize(16777215, 50))
        ...
        self.verticalLayout.addWidget(self.groupBoxTransform)
        ...
        self.treeViewROIs.setMinimumSize(QtCore.QSize(280, 10))
        self.treeViewROIs.setMaximumSize(QtCore.QSize(280, 16777215))
        ...
        self.treeViewAnalysis.setMinimumSize(QtCore.QSize(280, 10))
        self.treeViewAnalysis.setMaximumSize(QtCore.QSize(280, 16777215))
    ...
    def retranslateUi(self, WidgetTiff):
        ...
        self.groupBoxTransform.setTitle(_translate("WidgetTiff", "Transform"))
