...
class Ui_WidgetAnalyze(object):
    def setupUi(self, WidgetAnalyze):
        ...
        WidgetAnalyze.setMaximumSize(QtCore.QSize(350, 16777215))
        ...
        self.signalTypeLabel = QtWidgets.QLabel(self.tab)
        ...
        self.signalTypeComboBox = QtWidgets.QComboBox(self.tab)
        ...
        self.roiCalculationLabel = QtWidgets.QLabel(self.tab)
        ...
        self.roiCalculationLineEdit = QtWidgets.QComboBox(self.tab)
        self.roiCalculationLineEdit.setObjectName("roiCalculationLineEdit")
        self.roiCalculationLineEdit.addItem("")
        self.formLayoutRadius_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.roiCalculationLineEdit)
        self.verticalLayout_3.addLayout(self.formLayoutRadius_2)
        self.buttonBoxCondition = QtWidgets.QDialogButtonBox(self.tab)
        ...
        self.tabWidgetAnalysisSteps.addTab(self.tab, "")
        ...
        self.buttonBoxAnalyze.setStandardButtons(QtWidgets.QDialogButtonBox.Discard|QtWidgets.QDialogButtonBox.Ok)
    ...
    def retranslateUi(self, WidgetAnalyze):
        ...
        self.roiCalculationLineEdit.setItemText(0, _translate("WidgetAnalyze", "Mean"))
        self.tabWidgetAnalysisSteps.setTabText(self.tabWidgetAnalysisSteps.indexOf(self.tab), _translate("WidgetAnalyze", "Condition"))
