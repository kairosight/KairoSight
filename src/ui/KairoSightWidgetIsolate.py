...
class Ui_WidgetIsolate(object):
    def setupUi(self, WidgetIsolate):
        ...
        self.centerXLabel = QtWidgets.QLabel(self.tabCircle)
        self.centerXLabel.setObjectName("centerXLabel")
        self.formLayoutCenter.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.centerXLabel)
        self.centerXLineEdit = QtWidgets.QLineEdit(self.tabCircle)
        ...
        self.centerXLineEdit.setMinimumSize(QtCore.QSize(40, 0))
        self.centerXLineEdit.setObjectName("centerXLineEdit")
        self.formLayoutCenter.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.centerXLineEdit)
        self.centerYPxLabel = QtWidgets.QLabel(self.tabCircle)
        self.centerYPxLabel.setObjectName("centerYPxLabel")
        self.formLayoutCenter.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.centerYPxLabel)
        self.centerYPxLineEdit = QtWidgets.QLineEdit(self.tabCircle)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Ignored, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.centerYPxLineEdit.sizePolicy().hasHeightForWidth())
        self.centerYPxLineEdit.setSizePolicy(sizePolicy)
        self.centerYPxLineEdit.setMinimumSize(QtCore.QSize(40, 0))
        self.centerYPxLineEdit.setObjectName("centerYPxLineEdit")
        self.formLayoutCenter.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.centerYPxLineEdit)
    ...
    def retranslateUi(self, WidgetIsolate):
        ...
        self.centerXLabel.setText(_translate("WidgetIsolate", "Center, X (px)"))
        self.centerXLineEdit.setText(_translate("WidgetIsolate", "0"))
        self.centerYPxLabel.setText(_translate("WidgetIsolate", "Center, Y (px)"))
        self.centerYPxLineEdit.setText(_translate("WidgetIsolate", "0"))
