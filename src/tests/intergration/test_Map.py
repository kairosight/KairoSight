...
class TestMapAnalysisRat(unittest.TestCase):
    def setUp(self):
        ...
        # file_name_rat = '2020/01/09 rata-05, Ca, ' + exp_name + ' PCL 200ms'
        ...
        # Reduce
        self.reduction = 5
        self.scale_cm_px = 0.036914 * self.reduction
        ...
        # self.kernel = 5
        # set to 2 cm
        self.kernel = floor(2 / self.scale_cm_px)
    ...
    def test_plot_duration_rat(self):
        ...
        # # Exclusion criteria
        # for iy, ix in np.ndindex(analysis_map.shape):
        #     if (analysis_map[iy, ix] < DUR_MIN) or (analysis_map[iy, ix] > DUR_MAX):
        #         print('* Excluded pixel ({}x{} with value: {})'
        #               .format(ix, iy, analysis_map[iy, ix]))
        #         analysis_map[iy, ix] = np.nan
